...
class WebSiteTemp(Enum):
    ...
    novel_title_xpath: any = ["//div[@class='header']/h1/descendant-or-self::text()",
                              "//div[@id='book']/div[@class='path']/div[@class='p']/a[last("
                              ")]/descendant-or-self::text()",
                              "//div[@id='wrapper']/div[@class='content_read']/div[@class='box_con']/div["
                              "@class='con_top']/a[last()]/descendant-or-self::text()"]
    ...
    novel_page_title_xpath: any = ["//div[@id='nr_title']/descendant-or-self::text()",
                                   ...
                                   "//div[@id='wrapper']/div[@class='content_read']/div[@class='box_con']/div["
                                   "@class='bookname']/h1/descendant-or-self::text()"]
