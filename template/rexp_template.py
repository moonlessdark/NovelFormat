...
class template(Enum):
    ...
    ad_str = [('\(天才只需一秒就能记住', 'com\)'), ('最新找回', 'ＣＯＭ'), ('【最新发布地址', '找到回家的路!】'), ('【发布地址', 'COM】'),
              ...
              ('【收藏不迷路', '以备不时之需】'), ('发布地址', '收藏不迷路！'), ('地阯發鈽', '.com'), ('地阯发钚', '.com'),
              ('【手机看小说', '℃-〇-㎡】')]
    ...
    以下为单行检测模式的自定义模板
    """
    # 结束符，碰到这些字符就开始检测是否需要换行
    wrap_character_by_line = ["”", "。", "，", "？", "！", '；']